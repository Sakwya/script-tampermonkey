...
(function () {
    ...
    //去除大概不需要的信息
    var course_list = document.body.getElementsByClassName("wzy_couros_row");
    var course_r = creatdiv("wzy_couros");
    course_r.className = ("wzy_couros");
    for (let i = 0; i < course_list.length; i++) {
        course_list[i].setAttribute("cid", course_list[i].parentElement.getAttribute("cid"));
        course_r.appendChild(course_list[i].cloneNode(true));
    }
    ...
    var course_ele = course_r.children;
    ...
    for (let i = 0; i < course_ele.length; i++) {
        ...
        course_b.innerHTML = course_ele[i].children[2].firstElementChild.innerHTML;
